...
export declare function handleWasmError(e: Error, cmd: string, onError?: (errorMessage: string) => void): void;
export declare function handleFormatPanic(tryCb: () => void): void;
