...
describe('simple', function () {
  ...
  it('should go to local server', async () => {
    ...
    assert__default["default"].deepStrictEqual(output, {
      product: 'test',
      cli_path_hash: localCliPathHash,
      current_version: '0.0.2',
      current_release_date: 1577712063907,
  ...
  it('should return reminded if recently reminded', async () => {
    ...
    await waitMs(500);
    assert__default["default"].strictEqual(result.status, 'reminded', `expected status to be reminded, got: ${result.status}`);
    assert__default["default"].deepStrictEqual(result.data, {
      product: 'test',
      cli_path_hash: localCliPathHash,
      current_version: '0.0.2',
