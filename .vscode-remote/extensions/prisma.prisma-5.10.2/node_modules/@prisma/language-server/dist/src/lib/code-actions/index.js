...
function quickFix(textDocument, params, onError) {
    ...
    for (const diag of diagnostics) {
        if (diag.severity === vscode_languageserver_1.DiagnosticSeverity.Error &&
            ...
            const lines = (0, ast_1.convertDocumentTextToTrimmedLineArray)(textDocument);
            const spellingSuggestion = getSpellingSuggestions(diagText, (0, ast_1.getAllRelationNames)(lines, constants_1.relationNamesRegexFilter));
